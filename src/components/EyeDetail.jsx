...
import { byproduct1 } from '../data/aei';

const EyeDetail = () => {
  const [data,setData] =useState(1);
    const {id} =useParams();
    const detail = byproduct1.find((x)=>x.id==id)
  ...
  <div className="row">
    ...
    <label className='fs-6' style={{marginLeft:"20%"}}>  Quantity</label>
...
<label htmlFor='inputQuantity'className='fs-3 me-5 mx-1' onClick={()=>setData(data-1)}>-</label>
         ...
         {/* <input type="" placeholder= {data}  className="form-control quantity" /> */}
